...
public interface ProductService {
    ...
    ProcessResult<Long> createProduct(NewProductDto productDto) throws IOException;
    ProcessResult<Long> updateProduct(Long id, UpdateProductDto productDto) throws IOException;
}
